...
namespace stellar_dotnetcore_sdk.requests
{
    public class LedgersRequestBuilder : RequestBuilder<LedgersRequestBuilder>
    {
        ...
        public override RequestBuilder<LedgersRequestBuilder> Limit(int number)
        {
            base.Limit(number);
            return this;
        }
        ...
        public override RequestBuilder<LedgersRequestBuilder> Order(OrderDirection direction)
        {
