...
namespace stellar_dotnetcore_sdk.responses.operations
{
    public class CreatePassiveOfferOperationResponse : OperationResponse
    {
        ...
        public Asset BuyingAsset => Asset.GetNonNativeAsset(BuyingAssetType, BuyingAssetIssuer, BuyingAssetCode);

        public Asset SellingAsset => Asset.GetNonNativeAsset(SellingAssetType, SellingAssetIssuer, SellingAssetCode);
    }
}