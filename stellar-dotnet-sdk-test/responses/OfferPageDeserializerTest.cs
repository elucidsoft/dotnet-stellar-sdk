...
namespace stellar_dotnet_sdk_test.responses
{
    ...
    public class OfferPageDeserializerTest
    {
        ...
        public static void AssertTestData(Page<OfferResponse> offerResponsePage)
        {
            ...
            Assert.AreEqual(offerResponsePage.Records[0].Seller.AccountId, "GA2IYMIZSAMDD6QQTTSIEL73H2BKDJQTA7ENDEEAHJ3LMVF7OYIZPXQD");
            Assert.AreEqual(offerResponsePage.Records[0].PagingToken, "241");
            Assert.AreEqual(offerResponsePage.Records[0].Selling, Asset.CreateNonNativeAsset("INR", KeyPair.FromAccountId("GA2IYMIZSAMDD6QQTTSIEL73H2BKDJQTA7ENDEEAHJ3LMVF7OYIZPXQD")));
            Assert.AreEqual(offerResponsePage.Records[0].Buying, Asset.CreateNonNativeAsset("USD", KeyPair.FromAccountId("GA2IYMIZSAMDD6QQTTSIEL73H2BKDJQTA7ENDEEAHJ3LMVF7OYIZPXQD")));
            ...
            Assert.AreEqual(offerResponsePage.Links.Next.Href, "https://horizon-testnet.stellar.org/accounts/GA2IYMIZSAMDD6QQTTSIEL73H2BKDJQTA7ENDEEAHJ3LMVF7OYIZPXQD/offers?order=asc&limit=10&cursor=241");
