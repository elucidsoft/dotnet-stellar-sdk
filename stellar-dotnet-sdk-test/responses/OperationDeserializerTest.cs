...
namespace stellar_dotnet_sdk_test.responses
{
    ...
    public class OperationDeserializerTest
    {
        ...
        public void TestSerializeDeserializeCreateAccountOperation()
        {
            var json = File.ReadAllText(Path.Combine("testdata", "operationCreateAccount.json"));
            var instance = JsonSingleton.GetInstance<OperationResponse>(json);
            var serialized = JsonConvert.SerializeObject(instance, new OperationDeserializer());
            var back = JsonConvert.DeserializeObject<OperationResponse>(serialized, new OperationDeserializer());
        ...
        public static void AssertCreateAccountOperationData(OperationResponse instance)
        {
            ...
            Assert.AreEqual(operation.SourceAccount.AccountId,
        ...
        private static void AssertAllowTrustData(OperationResponse instance)
        {
            ...
            Assert.AreEqual(operation.Asset,
                Asset.CreateNonNativeAsset("EUR",
                    KeyPair.FromAccountId("GDIROJW2YHMSFZJJ4R5XWWNUVND5I45YEWS5DSFKXCHMADZ5V374U2LM")));
        }
        ...
        private static void AssertSetOptionsData(OperationResponse instance)
        {
            ...
            Assert.AreEqual(operation.InflationDestination.AccountId,
        ...
        private static void AssertManageOfferData(OperationResponse instance)
        {
            ...
            Assert.AreEqual(operation.BuyingAsset,
                Asset.CreateNonNativeAsset("CNY",
                    KeyPair.FromAccountId("GAZWSWPDQTBHFIPBY4FEDFW2J6E2LE7SZHJWGDZO6Q63W7DBSRICO2KN")));
        ...
        private static void AssertPathPaymentData(OperationResponse instance)
        {
            ...
            Assert.AreEqual(operation.Asset,
                Asset.CreateNonNativeAsset("EUR",
                    KeyPair.FromAccountId("GCQPYGH4K57XBDENKKX55KDTWOTK5WDWRQOH2LHEDX3EKVIQRLMESGBG")));
            Assert.AreEqual(operation.SendAsset,
                Asset.CreateNonNativeAsset("USD",
                    KeyPair.FromAccountId("GC23QF2HUE52AMXUFUH3AYJAXXGXXV2VHXYYR6EYXETPKDXZSAW67XO4")));
        }
        ...
        private static void AssertCreatePassiveOfferData(OperationResponse instance)
        {
            ...
            Assert.AreEqual(operation.BuyingAsset,
                Asset.CreateNonNativeAsset("USD",
                    KeyPair.FromAccountId("GDS5JW5E6DRSSN5XK4LW7E6VUMFKKE2HU5WCOVFTO7P2RP7OXVCBLJ3Y")));
            Assert.AreEqual(operation.SellingAsset, new AssetTypeNative());
        }
