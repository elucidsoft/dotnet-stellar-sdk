...
namespace stellar_dotnet_sdk_test.responses
{
    ...
    public class OperationPageDeserializerTest
    {
        ...
        public static void AssertTestData(Page<OperationResponse> operationsPage)
        {
            ...
            Assert.AreEqual(createAccountOperation.Account.AccountId,
                "GDFH4NIYMIIAKRVEJJZOIGWKXGQUF3XHJG6ZM6CEA64AMTVDN44LHOQE");
            Assert.AreEqual(createAccountOperation.Funder.AccountId,
            ...
            Assert.AreEqual(paymentOperation.From.AccountId,
