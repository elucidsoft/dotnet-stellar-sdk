...
//  ===========================================================================
    public class PathPaymentStrictReceiveResultCode
    {
        ...
        public PathPaymentStrictReceiveResultCodeEnum InnerValue { get; set; } =
            default(PathPaymentStrictReceiveResultCodeEnum);
        ...
        public static PathPaymentStrictReceiveResultCode Decode(XdrDataInputStream stream)
        {
            ...
            switch (value)
            {
                ...
                case -4:
                    return Create(PathPaymentStrictReceiveResultCodeEnum
                        .PATH_PAYMENT_STRICT_RECEIVE_SRC_NOT_AUTHORIZED);
                case -5:
                    return Create(PathPaymentStrictReceiveResultCodeEnum.PATH_PAYMENT_STRICT_RECEIVE_NO_DESTINATION);
                case -6: return Create(PathPaymentStrictReceiveResultCodeEnum.PATH_PAYMENT_STRICT_RECEIVE_NO_TRUST);
                case -7:
                    return Create(PathPaymentStrictReceiveResultCodeEnum.PATH_PAYMENT_STRICT_RECEIVE_NOT_AUTHORIZED);
                ...
                case -10:
                    return Create(PathPaymentStrictReceiveResultCodeEnum.PATH_PAYMENT_STRICT_RECEIVE_TOO_FEW_OFFERS);
                case -11:
                    return Create(PathPaymentStrictReceiveResultCodeEnum.PATH_PAYMENT_STRICT_RECEIVE_OFFER_CROSS_SELF);
                case -12:
                    return Create(PathPaymentStrictReceiveResultCodeEnum.PATH_PAYMENT_STRICT_RECEIVE_OVER_SENDMAX);
                default:
