...
namespace stellar_dotnetcore_unittest
{
    ...
    public class OperationTest
    {
        ...
        public void TestCreateAccountOperation()
        {
            ...
            sdkxdr.Operation xdr = operation.ToXdr();
        ...
        public void TestSetOptionsOperation()
        {
            ...
            // GBCP5W2VS7AEWV2HFRN7YYC623LTSV7VSTGIHFXDEJU7S5BAGVCSETRR
            sdkxdr.SignerKey signer = Signer.Ed25519PublicKey(KeyPair.FromSecretSeed("SA64U7C5C7BS5IHWEPA7YWFN3Z6FE5L6KAMYUIT4AQ7KVTVLD23C6HEZ"));
        ...
        public void TestSetOptionsOperationSignerSha256()
        {
            ...
            byte[] preimage = Encoding.UTF8.GetBytes("stellar.org");
            ...
            Assert.IsTrue(Enumerable.SequenceEqual(hash, parsedOperation.Signer.HashX.InnerValue));
        ...
        public void TestSetOptionsOperationPreAuthTxSigner()
        {
            ...
            Assert.AreEqual(null, parsedOperation.HighThreshold);
            Assert.AreEqual(null, parsedOperation.HomeDomain);
            Assert.IsTrue(Enumerable.SequenceEqual(transaction.Hash(), parsedOperation.Signer.PreAuthTx.InnerValue));
            Assert.AreEqual(10, parsedOperation.SignerWeight);
        ...
        public void TestManageDataOperation()
        {
            ...
            Assert.IsTrue(Enumerable.SequenceEqual(new byte[] { 0, 1, 2, 3, 4 }, parsedOperation.Value));
