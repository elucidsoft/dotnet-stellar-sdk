...
namespace stellar_dotnetcore_unittest.xdr
{
    ...
    public class TransactionDecodeTest
    {
        ...
        public void TestDecodeTxBody()
        {
            ...
            byte[] bytes = Convert.FromBase64String(txBody);
            GetDebugBytes(bytes);

            MemoryStream memoryStream = new MemoryStream(bytes);
            var transactionEnvelope = TransactionEnvelope.Decode(new XdrDataInputStream(bytes));

            long uint64 = transactionEnvelope.Tx.SeqNum.InnerValue.InnerValue;
        ...
        public void TestDecodeTxResult()
        {
            ...
            byte[] bytes = Convert.FromBase64String(txResult);
        ...
        public void TestDecodeTxMeta()
        {
            ...
            byte[] bytes = Convert.FromBase64String(txMeta);
        ...
        public void TestTransactionEnvelopeWithMemo()
        {
            ...
            byte[] bytes = Convert.FromBase64String(transactionEnvelopeToDecode);
        ...
        {
            sbyte[] debugBytes = bytes.Select(a => (sbyte)a).ToArray();
        }
    }
}
